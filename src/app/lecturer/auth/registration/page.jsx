...
export default function Page() {
  ...
  const registerNewUser = async (e) => {
    ...
    const firstValidPattern = /^.*@varsitycollege.ac.za$/;
    const secondValidPattern = /^.*@iie.ac.za$/;
    if (
      !firstValidPattern.test(data.email) &&
      !secondValidPattern.test(data.email)
    ) {
      setIsLoading(false);
