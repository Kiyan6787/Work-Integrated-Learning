  ...
  const CardData = [
    {
      ...
      value: await students.length,
    },
    {
      id: 2,
      heading: "Groups",
      subheading: "Number of Groups",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
      ...
      value: await groups.length,
    },
    {
      id: 3,
      heading: "NGOs",
      subheading: "Registered NGOs",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
